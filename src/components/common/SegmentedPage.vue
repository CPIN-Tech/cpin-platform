      ...
      <div class="sidebar flex flex-col" ref="sidebar" v-if="sidebarAvailable">
        ...
        <div class="sidebar-main grow" v-if="$slots['sidebar-content']">
          <n-scrollbar style="max-height: 100%">
            <div class="sidebar-main-content" :style="sidebarContentStyle">
      ...
      <div class="main flex-grow flex flex-col">
        <div class="main-toolbar flex items-center" v-if="$slots['main-toolbar']">
          <div
            ...
            v-if="sidebarAvailable && !hideMenuBtn"
          >
        ...
        <div class="main-view grow" :class="{ 'no-container-query': disableContainerQuery }">
          <n-scrollbar style="max-height: 100%" v-if="useMainScroll" ref="mainScrollbar">
            <div class="main-content" :style="mainContentStyle">
              <slot name="main-content"></slot>
            </div>
          </n-scrollbar>
          <div class="main-content" :style="mainContentStyle" v-else>
            <slot name="main-content"></slot>
          </div>
        </div>
...
const { sidebarPosition, hideMenuBtn, useMainScroll, mainContentStyle, sidebarContentStyle } =
  toRefs(props);
