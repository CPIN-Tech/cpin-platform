          ...
          <div class="scrollbar-wrapper" :style="lazy ? { height: wrapperHeight + 'px' } : {}">
            <n-scrollbar style="max-height: 100%" v-if="loaded || !lazy">
              <n-timeline>
                ...
                <n-timeline-item type="info" :content="text3" :time="date2">
                  <template #icon>
                    <Icon :size="8" :name="DotIcon"></Icon>
                  </template>
                </n-timeline-item>
                <n-timeline-item type="info" :content="text4" :time="date3">
                  <template #header>
                    <n-tag type="info" size="small">Warning</n-tag>
                  </template>
                  <template #icon>
                    <Icon :size="8" :name="DotIcon"></Icon>
                  </template>
                ...
                >
                  <template #header>
                    <n-tag type="error" size="small">Info</n-tag>
                  </template>
                  <template #icon>
                    <Icon :size="8" :name="DotIcon"></Icon>
                  </template>
...
const headerTitle = 'Platform Actions';
const text1 = 'CPIN ';
const text2 = 'CPIN platform launched ';
const text3 = 'Novi Sad, Serbia VPP1 launched ';
const text4 = 'Vancouver, Canada VPP1 launched ';
const text5 = 'Novi Sad, Serbia VPP1 sold out ';
...
const date1 = dayjs('2024-09-01').add(15, 'hour').format('DD-MM-YYYY HH:mm');
const date2 = dayjs('2024-09-02').add(8, 'hour').format('DD-MM-YYYY HH:mm');
const date3 = dayjs('2024-09-04').add(11, 'hour').format('DD-MM-YYYY HH:mm');
const date4 = dayjs('2024-09-07').add(13, 'hour').format('DD-MM-YYYY HH:mm');
