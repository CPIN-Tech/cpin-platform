    ...
    extend: {
      ...
      backgroundImage: {
        'custom-radial-gradient':
          'radial-gradient(96.02% 99.41% at 1.84% 0%, rgb(136, 120, 195) 30%, rgb(108, 114, 132) 100%)',
      },
    },
  },
  plugins: [
    plugin(function ({ addBase, theme }) {
      addBase({
        h1: {
          ...
          fontWeight:
            getValue(tokens, tokens?.typography?.h1?.fontWeight) || theme('fontWeight.bold'),
        ...
        h2: {
          ...
          fontWeight:
            getValue(tokens, tokens?.typography?.h2?.fontWeight) || theme('fontWeight.bold'),
        ...
        h3: {
          ...
          fontWeight:
            getValue(tokens, tokens?.typography?.h3?.fontWeight) || theme('fontWeight.bold'),
        ...
        h4: {
          ...
          fontWeight:
            getValue(tokens, tokens?.typography?.h4?.fontWeight) || theme('fontWeight.medium'),
        ...
        h5: {
          ...
          fontWeight:
            getValue(tokens, tokens?.typography?.h5?.fontWeight) || theme('fontWeight.bold'),
        ...
        h6: {
          ...
          fontWeight:
            getValue(tokens, tokens?.typography?.h6?.fontWeight) || theme('fontWeight.bold'),
